...
function getRandomImage(keyword, count) {
    ...
    return new Promise (function (resolve, reject) {
        ...
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=YYsTPkDpbgZyfnrtRIoH8XBy5FzAmMpAL_r6IgNNiyE&featured=true&orientation=landscape&query=${keyword}`;
